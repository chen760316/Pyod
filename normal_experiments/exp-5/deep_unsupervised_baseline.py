...
if __name__ == '__main__':
    paths = [
        "../datasets/real_outlier_varying_ratios/Annthyroid/Annthyroid_02_v01.csv",
        ...
        "../datasets/synthetic_outlier/annthyroid_0.1.csv",
        "../datasets/synthetic_outlier/annthyroid_0.2.csv",
        "../datasets/synthetic_outlier/annthyroid_0.3.csv",
