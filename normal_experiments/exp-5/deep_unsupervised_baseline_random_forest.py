...
# print("random forest模型在加噪测试集中的分类精确度：" + str(precision_score(y_test, y_test_pred, average='macro', zero_division=0)))
...
# print("random forest模型在修复测试集中的分类精确度：" + str(precision_score(y_test, y_test_pred, average='macro', zero_division=0)))
print("random forest模型在修复测试集中的分类精确度：" + str(precision_score(y_test, y_test_pred, average='weighted')))
