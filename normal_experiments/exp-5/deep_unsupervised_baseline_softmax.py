...
# print("softmax模型在加噪测试集中的分类精确度：" + str(precision_score(y_test, y_test_pred, average='macro', zero_division=0)))
...
# print("softmax模型在修复测试集中的分类精确度：" + str(precision_score(y_test, y_test_pred, average='macro', zero_division=0)))
print("softmax模型在修复测试集中的分类精确度：" + str(precision_score(y_test, y_test_pred, average='weighted')))
...
"""ROC-AUC指标"""
y_test_prob = softmax_repair.predict_proba(X_test_copy)
