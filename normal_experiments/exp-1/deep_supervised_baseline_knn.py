...
print("*" * 100)
knn_clf_model = KNeighborsClassifier(n_neighbors=22)
knn_clf_model.fit(X_train, y_train)
train_label_pred = knn_clf_model.predict(X_train)
test_label_pred = knn_clf_model.predict(X_test)
...
print("*" * 100)
knn_clf_model_noise = KNeighborsClassifier(n_neighbors=22)
knn_clf_model_noise.fit(X_train_copy, y_train)
train_label_pred_noise = knn_clf_model_noise.predict(X_train_copy)
test_label_pred_noise = knn_clf_model_noise.predict(X_test_copy)
...
predict_fn = lambda x: knn_clf_model.predict_proba(x)
...
knn_clf_repair = KNeighborsClassifier(n_neighbors=22)
knn_clf_repair.fit(X_train_copy, y_train)
y_train_pred = knn_clf_repair.predict(X_train_copy)
y_test_pred = knn_clf_repair.predict(X_test_copy)
...
#
# knn_clf_repair = KNeighborsClassifier(n_neighbors=22)
# knn_clf_repair.fit(X_train_copy_repair, y_train_copy_repair)
# y_train_pred = knn_clf_repair.predict(X_train_copy_repair)
# y_test_pred = knn_clf_repair.predict(X_test_copy_repair)
#
# print("*" * 100)
# # 训练样本中被KNN模型错误分类的样本
