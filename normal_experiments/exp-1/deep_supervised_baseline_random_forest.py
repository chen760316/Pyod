...
print("*" * 100)
random_forest_model = RandomForestClassifier(n_estimators=50, max_depth=10, min_samples_split=10, min_samples_leaf=4, random_state=42, class_weight='balanced')
random_forest_model.fit(X_train, y_train)
train_label_pred = random_forest_model.predict(X_train)
test_label_pred = random_forest_model.predict(X_test)
...
print("*" * 100)
random_forest_model_noise = RandomForestClassifier(n_estimators=50, max_depth=10, min_samples_split=10, min_samples_leaf=4, random_state=42, class_weight='balanced')
random_forest_model_noise.fit(X_train_copy, y_train)
train_label_pred_noise = random_forest_model_noise.predict(X_train_copy)
test_label_pred_noise = random_forest_model_noise.predict(X_test_copy)
...
predict_fn = lambda x: random_forest_model.predict_proba(x)
...
random_forest_repair = RandomForestClassifier(n_estimators=50, max_depth=10, min_samples_split=10, min_samples_leaf=4, random_state=42, class_weight='balanced')
random_forest_repair.fit(X_train_copy, y_train)
y_train_pred = random_forest_repair.predict(X_train_copy)
y_test_pred = random_forest_repair.predict(X_test_copy)
...
#
# random_forest_repair = RandomForestClassifier(n_estimators=50, max_depth=10, min_samples_split=10, min_samples_leaf=4, random_state=42, class_weight='balanced')
# random_forest_repair.fit(X_train_copy_repair, y_train_copy_repair)
# y_train_pred = random_forest_repair.predict(X_train_copy_repair)
# y_test_pred = random_forest_repair.predict(X_test_copy_repair)
#
# print("*" * 100)
# # 训练样本中被random forest模型错误分类的样本
