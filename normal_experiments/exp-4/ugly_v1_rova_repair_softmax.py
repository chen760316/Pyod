...
# softmax_model = svm.SVC(probability=True)
...
# softmax_clf = svm.SVC(probability=True)
...
"""ROC-AUC指标"""
# y_test_prob = softmax_model.predict_proba(X_test)
...
# # softmax_repair = svm.SVC(probability=True)
