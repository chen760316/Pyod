...
"""
横坐标的值应该是各算法在多个数据集上的平均排名 如果某两个算法的平均排名的差值大于CD值,则说明在统计学上有显著性差异
首先执行弗里德曼检验以拒绝零假设，然后我们根据Wilcoxon-Holm方法进行事后分析。
我们可以清楚地看到，平均而言，clf3和clf5是15个数据集上最好的算法。粗水平线表示一组没有显著差异的分类器。
"""
