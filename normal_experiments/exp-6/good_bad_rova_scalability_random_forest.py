...
with memory_timer():
    ...
    # 对训练数据进行处理后重新训练random forest模型

    # SECTION 原始数据中的random forest分类准确度
    # print("*" * 100)
    # print("原始训练集中random forest分类准确度：" + str(accuracy_score(y_train, rf_model.predict(X_train))))
    # print("原始测试集中random forest分类准确度：" + str(accuracy_score(y_test, rf_model.predict(X_test))))
    # print("*" * 100)
    ...
    # # 重新训练random forest模型
    # rf_model_split = RandomForestClassifier(n_estimators=50, max_depth=10, min_samples_split=10, min_samples_leaf=4, random_state=42, class_weight='balanced')
    # rf_model_split.fit(X_train_split, y_train_split)
    # print("*" * 100)
    # print("去除异常值中分类错误的样本后的训练集random forest分类准确度：" + str(accuracy_score(y_train_split, rf_model_split.predict(X_train_split))))
    # print("去除异常值中分类错误的样本后的测试集random forest分类准确度：" + str(accuracy_score(y_test, rf_model_split.predict(X_test))))
    # print("*" * 100)
    ...
    # rf_model_h = RandomForestClassifier(n_estimators=50, max_depth=10, min_samples_split=10, min_samples_leaf=4, random_state=42, class_weight='balanced')
    # rf_model_h.fit(X_train_h, y_train_h)
    # print("*" * 100)
    # print("去除损失高于阈值的样本后的训练集random forest分类准确度：" + str(accuracy_score(y_train_h, rf_model_h.predict(X_train_h))))
    # print("去除损失高于阈值的样本后的测试集random forest分类准确度：" + str(accuracy_score(y_test, rf_model_h.predict(X_test))))
    # print("*" * 100)
    ...
    # rf_model_o = RandomForestClassifier(n_estimators=50, max_depth=10, min_samples_split=10, min_samples_leaf=4, random_state=42, class_weight='balanced')
    # rf_model_o.fit(X_train_o, y_train_o)
    # print("*" * 100)
    # print("去除判定为异常的样本后的训练集random forest分类准确度：" + str(accuracy_score(y_train_o, rf_model_o.predict(X_train_o))))
    # print("去除判定为异常的样本后的测试集random forest分类准确度：" + str(accuracy_score(y_test, rf_model_o.predict(X_test))))
    # print("*" * 100)